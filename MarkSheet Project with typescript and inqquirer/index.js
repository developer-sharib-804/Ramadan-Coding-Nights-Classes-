...
let answer = await inquirer.prompt([
    { message: "Enter your English Number", name: "english", type: "number" },
    { message: "Enter your Urdu Number", name: "urdu", type: "number" },
    { message: "Enter your Math Number", name: "math", type: "number" },
    { message: "Enter your Physics Number", name: "physics", type: "number" },
